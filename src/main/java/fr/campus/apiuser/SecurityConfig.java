...
import fr.campus.apiuser.service.JwtAuthenticationFilter;
...
@Configuration
@EnableWebSecurity // active la sécurité des requêtes HTTP
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
                ...
                // Ajoute notre filtre JWT avant le filtre d'authentification classique
                .addFilterBefore(
